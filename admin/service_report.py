...
def main():
    ...
    # Map Service search limited to your items 
    map_services = gis.content.search(query=f"type:Map Service owner:{username}", 
                                    item_type="Map Service", 
                                    max_items=10000)

    # Feature Service search limited to your items
    feature_services = gis.content.search(query=f"type:Feature Service owner:{username}",
                                        item_type="Feature Service", 
                                        max_items=10000)

    # Vector Tile Service search limited to your items  
    vector_services = gis.content.search(query=f"type:Vector Tile Service owner:{username}",
                                        item_type="Vector Tile Service", 
                                        max_items=10000)
                                        
    # Image Service search limited to your items
    image_services = gis.content.search(query=f"type:Image Service owner:{username}",
