...
set PATH=C:\Program Files\QGIS 3.34.4\apps\qgis-ltr\bin;C:\OSGeo4W64\apps\Qt5\bin;%PATH%
set PYTHONPATH=C:\Program Files\QGIS 3.34.4\apps\qgis-ltr\python;C:\Program Files\QGIS 3.34.4\apps\qgis-ltr\python\plugins;%PYTHONPATH%
set QGIS_PREFIX_PATH=C:\Program Files\QGIS 3.34.4\apps\qgis-ltr
@REM set QT_QPA_PLATFORM_PLUGIN_PATH=%OSGEO4W_ROOT%\apps\Qt5\plugins
