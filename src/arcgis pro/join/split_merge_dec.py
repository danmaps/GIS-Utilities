    ...
    def decorator(func):
        ...
        def wrapper(input_fc, output_fc, *args, **kwargs):
            ...
            for split_fc in split_tables:
                split_output_fc = os.path.join(temp_gdb, f"processed_{os.path.basename(split_fc)}")
...
class TestSplitMergeDecorator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Insert test data
        with arcpy.da.InsertCursor(self.input_fc, ["SHAPE@", "TestTField", "TestNField"]) as cursor:
            for i in range(8):
    ...
    def test_process_feature_class(self):
        ...
        expected_values = ["string_0", "string_1", "string_2", "string_3", "string_4", "string_5", "string_6", "string_7"]
        actual_values = []
